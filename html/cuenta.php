...
if (isset($_GET['act'])){
        ...
        $query = "UPDATE `cliente` SET `nombre`='".$_POST['nombre_p']."',
        `apellido`='".$_POST['apellido_p']."',
        `nacionalidad`='".$_POST['nacionalidad']."',
        `genero`='".$_POST['genero']."',
        `cedula`='".$_POST['cedula']."',   
        `fecha_nacimiento`='".$_POST['fecha']."',
        `cuenta_bancaria`='".$_POST['cuenta']."' WHERE id_usuario = '".$_SESSION['usuario']."'
        ";
        $result = mysql_query($query) or die('Consulta fallida: ' . mysql_error());   
        echo '<script>window.location.href = "?pag='.$_GET['pag'].'";</script>';
}
?>
<div class="db-cent-table db-com-table">
    ...
    <div class="db-profile-edit">
        <form class="s12" method="post" action="?pag=<?php echo $_GET['pag']; ?>&act=1">
            <div>
                <label>Usuario</label>
            ...
            <div>
                ...
                <div class="input-field s12">
                    <input type="date" class="validate" value="<?php echo $datos['fecha_nacimiento']; ?>" name="fecha">
            ...
            <div>
                ...
                <div class="input-field s12">
                    <input type="number" class="validate" value="<?php echo $datos['cuenta_bancaria']; ?>" name="cuenta">
