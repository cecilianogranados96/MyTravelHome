...
<div class="db-profile"> <img src="images/user.jpg" alt="">
				...
				<div class="db-profile-edit">
					<form class="col s12">
						...
						<div>
							<label class="col s4">Telefono</label>
							<div class="input-field col s8">
						...
						<div>
							<label class="col s4">Direccion</label>
							<div class="input-field col s8">
						...
						<div>
							<div class="input-field col s8">
								<input type="submit" value="Actualizar" class="waves-effect waves-light pro-sub-btn" id="pro-sub-btn"> </div>
						</div>
					</form>
				</div>
